...
public class FenlisteDeroulante {
	...
	private void initialize() {
		...
		choix.setBounds(218, 51, 107, 43);
		frame.getContentPane().add(choix);
		JLabel image = new JLabel("");
		image.setBounds(56, 10, 162, 136);
		...
		listederoulante.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(laSelection=="Poire"){
					ImageIcon imagegif = new ImageIcon ("Poire.jpg");
					image.setIcon(imagegif);
					choix.setBackground(Color.green);
					}
				if(laSelection=="Abricot"){
					ImageIcon imagegif = new ImageIcon ("Abricot.jpg");
					image.setIcon(imagegif);
					choix.setBackground(Color.yellow);
					}
				}
		});
		listederoulante.setBounds(32, 156, 153, 21);
